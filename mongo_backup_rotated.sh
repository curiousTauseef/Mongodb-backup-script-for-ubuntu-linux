...
BACKUP_PATH="/home/administrator/database/mongo" # do not include trailing slash
...
# Number of days to keep daily backups(copied from postgres config file)
DAYS_TO_KEEP=7

# Get todays date to use in filename of backup output
#TODAYS_DATE=`date "+%d-%m-%Y"`
TODAYS_DATE=`date +%d-%m-%Y_%Hh%Mm%Ss`
